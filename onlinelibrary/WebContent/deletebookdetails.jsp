        ...
        <div class="sidebar_box">
           ...
           <h2>JAVA</h2>
            ...
            <div class="section_w250 float_l">
				<h3>Core Java</h3>            
				<p>oops is a concept of core java so. is realy a very good website we must visit,on this web site,to know java in defth,and .</p>
           </div>
...
<%@ page import="com.tiaratechSolutions.*" %>
            ...
            <div class="section_w250 float_l">
				<h3>Core Java</h3>            
				<p>oops is a concept of core java so. .com ,is realy a very good website we must visit,on this web site,to know java in defth.</p>
           </div>
...
<div id="templatemo_footer_wrapper">
    ...
    <div id="templatemo_footer">
        ...
        <ul class="footer_menu">
                ...
                <a href="http://www..com" target="_parent">Website Projects</a> by <a href="http://www..com" target="_parent">.com</a></div>
    
</div>
<div align=center>This project  downloaded form <a href='http://www..com/'>free website projects</a></div></body>
</html>