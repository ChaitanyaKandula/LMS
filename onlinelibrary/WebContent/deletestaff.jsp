	...
	<div id="templatemo_sidebar">
        ...
        <div class="sidebar_box">
            ...
            <div class="section_w250 float_l">
				<h3>Core Java</h3>            
				<p>oops is a concept of core java so. tiaratechSolutions.com ,is realy a very good website we must visit,on this web site,to know java in defth and cstpoint.com.</p>
           </div>
...
<%@ page import="com.tiaratechSolutions.*" %>
